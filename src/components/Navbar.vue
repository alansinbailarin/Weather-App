  ...
  >
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div class="flex p-2 items-center justify-between">
        <div
          class="inline-flex items-center text-gray-600 dark:text-gray-300 font-medium"
        >
          <div>
            <svg
          ...
          <div
            v-if="loading"
            class="ml-2 h-2.5 bg-gray-200 rounded-full dark:bg-gray-700 w-24"
          ></div>
          <span v-else class="ml-2 mt-0.5">
            {{ dataCurrent.name }}
          </span>
        </div>
        <div class="inline-flex items-center gap-4">
          <div class="inline-flex items-center text-gray-700 dark:text-white">
            <div class="hidden md:inline-flex gap-4">
              <a href="https://github.com/alansinbailarin" target="_blank">
              ...
              <a
                href="https://www.instagram.com/alansinthb/"
                target="_blank"
                class="text-blue-500"
              >
          ...
          <div>
            <span class="sr-only">Espacio</span>
            <h1 class="text-xl text-gray-300 dark:text-gray-500">|</h1>
          </div>
          <div>
            <button
              @click="changeDarkMode"
              class="p-2 text-yellow-400 rounded-md transition-all duration-300 ease-in-out hover:bg-gray-200 dark:hover:bg-gray-700"
            >
...
import type { weather } from "@/interfaces/fiveDaysWeather";
